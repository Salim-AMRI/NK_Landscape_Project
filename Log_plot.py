...
log_filename = 'logTrajectory_strategyNN_N_64_K_1_nb_instances_test_0_nb_restarts_0.log'
...
ax1.set_title("Fitness evolution curve over iterations", fontsize=24)
ax1.grid(True)

# Ajoutez le graphique du bas : Nuage de points pour Positive Count et Actions Above Count
ax2.scatter(iterations, positive_counts, marker='o', s=30, label='Nbre of candidate solutions', color='blue')
ax2.scatter(iterations, actions_above_counts, marker='x', s=30, label='Rank of the selected solution', color='red')
ax2.set_xlabel("Number of iterations", fontsize=20)
ax2.set_ylabel("Values", fontsize=20)
ax2.set_title("Number of positive scored solutions and ranked solutions selected over iterations", fontsize=24)
