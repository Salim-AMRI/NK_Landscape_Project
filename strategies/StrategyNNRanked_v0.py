...
class StrategyNNRanked_v0(Strategy):
    ...
    def choose_action(self, env):
        ...
        neighDeltaFitnessSortedIndex = np.argsort(neighDeltaFitness)/self.N



        stacked_input_th = torch.tensor(neighDeltaFitnessSortedIndex, dtype=torch.float32).unsqueeze(0).unsqueeze(2)
